...
import { BellElectricIcon, BookAIcon, ChevronLeftCircle, ChevronLeftCircleIcon, ChevronRightCircleIcon, HomeIcon, IceCream2, Laptop2Icon, MicrochipIcon, ShieldAlert, ShirtIcon, ShovelIcon, ToyBrickIcon } from 'lucide-react'
...
const categoriesWithIcons = [
  { id: 'electronics', value: 'electronics', label: 'Electronics', icon: BellElectricIcon },
  { id: 'fashion', value: 'fashion', label: 'Fashion', icon: ShirtIcon },
  { id: 'home-appliances', value: 'home-appliances', label: 'Home Appliances', icon: ShieldAlert },
  { id: 'books', value: 'books', label: 'Books', icon: BookAIcon },
  { id: 'toys', value: 'toys', label: 'Toys', icon: ToyBrickIcon }

]

const BrandWithIcons = [
  { value: 'nike', id: 'nike', label: 'Nike', icon: ShovelIcon },
  { value: 'hp', id: 'hp', label: 'HP', icon: Laptop2Icon },
  { value: 'adidas', id: 'adidas', label: 'Adidas', icon: MicrochipIcon },
  { value: 'lenovo', id: 'lenovo', label: 'Lenovo', icon: IceCream2 },
]
