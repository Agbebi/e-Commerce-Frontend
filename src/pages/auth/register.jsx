...
import { ArrowRight, ArrowLeft, User, Mail, Lock, Phone, CheckCircle2 } from 'lucide-react'
import { motion, AnimatePresence } from 'framer-motion'

const step1Fields = ['userName', 'name', 'email', 'password']
const step2Fields = ['phoneNumber']
  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-500">Join us and start shopping today</p>
      </div>
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div className={`flex-1 h-0.5 rounded-full transition-all duration-300 ${step >= 2 ? 'bg-orange-500' : 'bg-slate-200'}`} />
        <div className="flex items-center gap-3">
          <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-300 ${
                ...
                <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-5">
                  <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Choose your username and password</p>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-5">
                  <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Almost done! Just a few more details</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-xl border border-slate-100">
                      ...
                      <label htmlFor="terms" className="text-xs text-slate-600 cursor-pointer leading-relaxed">
                        I agree to the{' '}
                        <Link to="#" className="text-orange-600 hover:text-orange-500 font-medium">Terms of Service</Link>
                        {' '}and{' '}
                        <Link to="#" className="text-orange-600 hover:text-orange-500 font-medium">Privacy Policy</Link>
                      </label>
                    </div>
                  </div>
                </div>
