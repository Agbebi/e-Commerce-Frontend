    ...
    <div className="w-full">
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-5">
            <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
              ...
              <div>
                <h3 className="text-sm font-semibold text-slate-900">Sign in to your account</h3>
      ...
      <div className="mt-6 space-y-2">
        <p className="text-sm text-slate-600 text-center">
          ...
          <Link to="/auth/register" className="font-semibold text-slate-900 hover:text-orange-600 transition-colors">
            Sign up
          </Link>
        </p>
        <p className="text-sm text-slate-600 text-center">
          Want to browse first?{' '}
          <Link to="/" className="font-semibold text-slate-900 hover:text-orange-600 transition-colors">
            Go to Marketplace
          </Link>
        </p>
      </div>
