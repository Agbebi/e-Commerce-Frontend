import { registerVendorFormControls } from '../../config/index'
...
function VendorAuthRegister() {
  ...
  return (
    <div className='mx-auto w-full h-full max-h-full overflow-auto flex flex-col justify-start md:justify-start bg-white p-8 md:p-4 rounded-lg max-w-md space-y-6 '>
          <div className='text-orange flex items-center justify-center my-4 gap-1'>
            {/* <CiShop size={30} /> */}
             Tim Marketplace.
          </div>
          ...
          <CommonForm
            formControls={registerVendorFormControls}
            buttonText={'Sign Up'}
            formData={formData}
