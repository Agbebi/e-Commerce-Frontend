...
function NumberSpinner({ id: idProp, label, error, size = 'small', ...other }) {
  let id = React.useId();
  if (idProp) {
    id = idProp;
  }
        ...
        <BaseNumberField.Input
          ...
          render={(props, state) => (
            <OutlinedInput
              ...
              sx={{ pr: 0, borderRadius: 0, flex: 1, fontSize: '11px', textAlign: 'center', outline: '2px', border: '2px' }}
            />
          )}
        />
