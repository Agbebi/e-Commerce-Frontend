      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900 items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 px-12 py-16 max-w-lg">
          <div className="flex items-center gap-3 mb-12">
            ...
            <span className="text-2xl font-bold text-white">Tim Marketplace</span>
          </div>
          
          <h1 className="text-4xl xl:text-5xl font-bold text-white mb-6 leading-tight">
            Your Gateway to <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">Premium Commerce</span>
          </h1>
          <p className="text-slate-300 text-lg mb-12 leading-relaxed">
            Join thousands of vendors and dispatchers building the future of marketplace commerce.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-white px-4 sm:px-6 lg:px-8 py-8 lg:py-0 relative">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8">
            ...
            <span className="text-xl font-bold text-slate-900">Tim Marketplace</span>
          </div>
          
          <div className="lg:hidden mb-6">
            <h2 className="text-lg font-semibold text-slate-900 mb-1">Premium Shopping Experience</h2>
